...
8. 作者反馈策略是 author_locked；必须逐条检查。风格问题只能进入 style_and_voice，不得伪装成连续性问题。
...
- [risk] [style_and_tone] tone.serious_scene_register: 危险、严肃或高压场景避免会消解紧张感的喜剧食物比喻；比喻必须符合人物视角、场景语域和当时情绪。
  - 原因：作者认为‘像一块散发着香味的红烧肉’虽然意思能懂，但不适合该危险场景。
  - 避免示例：像一块散发着香味的红烧肉
  - 来源：experiments/auxiliary_models_v1/annotation/feedback/author_feedback_20260801_quick003.json
...
- [blocking] [revision_scope] revision.one_issue_minimal_scope: 一次修订只解决作者指定的一个问题，采用能够解决问题的最小改动；确实必须改动其他情节时先停下并征求作者同意。
  - 原因：作者要求只有真正需要修改其他情节时才征求同意并修改。
  - 避免示例：修连续性时顺手新增长期世界规则或重写无关人物线
  - 倾向示例：只改时间词、首次见面措辞或必要的过渡句
  - 来源：docs/research/AUTHOR_REQUIREMENTS_AND_EVIDENCE_BASELINE_V1.md
